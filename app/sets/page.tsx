  ...
  return (
    <div className="flex-1 px-4 py-10 sm:py-14">
      <div className="mx-auto w-full max-w-4xl space-y-10">
        <div>
          <h1 className="text-3xl font-semibold text-ink">Sets de preguntas</h1>
            ...
            <div>
              ...
              {preguntas.length === 0 ? (
                <p className="text-sm text-muted">
                  Aún no tienes preguntas — crea algunas primero en el banco de preguntas.
                </p>
              ) : (
        ...
        <section>
          <h2 className="text-lg font-semibold text-ink">
            Tus sets <span className="font-normal text-muted">({sets.length})</span>
          </h2>
          {sets.length === 0 ? (
